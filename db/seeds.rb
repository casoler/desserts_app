...
supplier = Supplier.new(name: 'Cuban Delights', email: 'cuban_delights@gmail.com', phone: '555-555-5555')
supplier.save

supplier = Supplier.new(name: 'Peruvian Sweets', email: 'peruvian_sweets@gmail.com', phone: '666-666-6666')
supplier.save

supplier = Supplier.new(name: 'South American Sweets', email: 'south_american_sweets@gmail.com', phone: '777-777-7777')
supplier.save
